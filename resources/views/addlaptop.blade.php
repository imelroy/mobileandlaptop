...
<tr>
    <td>Platform</td>
    <td><select class="form-select" aria-label="Default select example" name="Platform">
...
<tr>
    <td>Processor</td>
    <td><select class="form-select" aria-label="Default select example" name="Processor">
...
<tr>
    <td>Graphics</td>
    <td><select class="form-select" aria-label="Default select example" name="Graphics">
